...
| rc | te_ext_02 | missing baseline | cost=0.20904429749391595, tdis=0.0, solve_ms=1.958 | - |
| rc | te_ext_02 | missing baseline | cost=0.20904424020805634, tdis=0.0, solve_ms=2.058 | - |
| rc | te_ext_02 | missing baseline | cost=0.20904425916087316, tdis=0.0, solve_ms=2.171 | - |
...
| rc | te_std_02 | missing baseline | cost=0.1930934969383334, tdis=0.0, solve_ms=1.99 | - |
| rc | te_std_02 | missing baseline | cost=0.193093498940072, tdis=0.0, solve_ms=1.924 | - |
| rc | te_std_02 | missing baseline | cost=0.1930935746919043, tdis=0.0, solve_ms=1.962 | - |
...
| pinn | te_ext_02 | missing baseline | cost=0.13885346471830448, tdis=0.0, solve_ms=130.249 | - |
| pinn | te_ext_02 | missing baseline | cost=0.13865729583600991, tdis=0.0, solve_ms=131.832 | - |
| pinn | te_ext_02 | missing baseline | cost=0.13870308845855142, tdis=0.0, solve_ms=133.694 | - |
...
| pinn | te_std_02 | missing baseline | cost=0.13777891145664345, tdis=0.0, solve_ms=53.125 | - |
| pinn | te_std_02 | missing baseline | cost=0.13772841036348052, tdis=0.0, solve_ms=54.389 | - |
| pinn | te_std_02 | missing baseline | cost=0.13780824014560628, tdis=0.0, solve_ms=53.697 | - |
...
| rbc | te_ext_01 | cost=0.12799340273899165, tdis=0.9180230829800947, solve_ms=0.0 | cost=0.12799340273899165, tdis=0.9180230829800947, solve_ms=0.0 | cost 0.00%; tdis 0.00%; solve_ms 0.00 ms |
| rbc | te_ext_01 | cost=0.12799340273899165, tdis=0.9180230829800947, solve_ms=0.0 | cost=0.12799340273899165, tdis=0.9180230829800947, solve_ms=0.0 | cost 0.00%; tdis 0.00%; solve_ms 0.00 ms |
| rbc | te_ext_02 | missing baseline | cost=0.12806431027759613, tdis=0.9180230829800947, solve_ms=0.0 | - |
| rbc | te_ext_02 | missing baseline | cost=0.12806431027759613, tdis=0.9180230829800947, solve_ms=0.0 | - |
| rbc | te_ext_02 | missing baseline | cost=0.12806431027759613, tdis=0.9180230829800947, solve_ms=0.0 | - |
...
| rbc | te_std_01 | cost=0.04835749296774106, tdis=0.20702369425814215, solve_ms=0.0 | cost=0.04835749296774106, tdis=0.20702369425814215, solve_ms=0.0 | cost 0.00%; tdis 0.00%; solve_ms 0.00 ms |
| rbc | te_std_01 | cost=0.04835749296774106, tdis=0.20702369425814215, solve_ms=0.0 | cost=0.04835749296774106, tdis=0.20702369425814215, solve_ms=0.0 | cost 0.00%; tdis 0.00%; solve_ms 0.00 ms |
| rbc | te_std_02 | missing baseline | cost=0.11312208248698438, tdis=1.3737305048752997, solve_ms=0.0 | - |
| rbc | te_std_02 | missing baseline | cost=0.11312208248698438, tdis=1.3737305048752997, solve_ms=0.0 | - |
| rbc | te_std_02 | missing baseline | cost=0.11312208248698438, tdis=1.3737305048752997, solve_ms=0.0 | - |
